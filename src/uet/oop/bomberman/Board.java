...
public class Board implements IRender {
	...
	protected final static int MAXLEVEL = 3;
	...
	private int _screenToShow = -1; //1:endgame, 2:changelevel, 3:paused, 4:congratulation.
	
	private int _time = Game.TIME;
	private int _points = Game.POINTS;

	public static SoundManager _screenSound = new SoundManager("sound/Level1.wav", 25);

	public SoundManager _completeLevelSound = new SoundManager("sound/level_complete.wav",0);

	public SoundManager _completeGame = new SoundManager("sound/win.wav",0);
	...
	public void update() {
		if (_game.is_end()) {
			int a = JOptionPane.showConfirmDialog(this.getGame(), "Play again?","Select an option:",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
			switch (a) {
				case JOptionPane.YES_OPTION:
					_game.set_end(false);
					_game.get_frame().setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
					new Frame();
					break;
	...
	public void drawScreen(Graphics g) {
		switch (_screenToShow) {
			...
			case 3:
				...
				break;
			case 4:
				_screen.drawCongratulation(g, _points);
				break;
